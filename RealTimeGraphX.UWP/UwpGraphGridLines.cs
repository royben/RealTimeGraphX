...
namespace RealTimeGraphX.UWP
{
    ...
    public class UwpGraphGridLines : UwpGraphComponentBase
    {
        /// <summary>
        ...
        public static readonly DependencyProperty RowsProperty =
            DependencyProperty.Register("Rows", typeof(int), typeof(UwpGraphGridLines), new PropertyMetadata(8, (d, e) => (d as UwpGraphGridLines).UpdateGridLines()));
        ...
        public static readonly DependencyProperty ColumnsProperty =
            DependencyProperty.Register("Columns", typeof(int), typeof(UwpGraphGridLines), new PropertyMetadata(8, (d, e) => (d as UwpGraphGridLines).UpdateGridLines()));
        ...
        public static readonly DependencyProperty VerticalItemsProperty =
            DependencyProperty.Register("VerticalItems", typeof(IEnumerable<int>), typeof(UwpGraphGridLines), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty HorizontalItemsProperty =
            DependencyProperty.Register("HorizontalItems", typeof(IEnumerable<int>), typeof(UwpGraphGridLines), new PropertyMetadata(null));

        /// <summary>
        /// Initializes a new instance of the <see cref="UwpGraphGridLines"/> class.
        /// </summary>
        public UwpGraphGridLines()
        {
            this.DefaultStyleKey = typeof(UwpGraphGridLines);
